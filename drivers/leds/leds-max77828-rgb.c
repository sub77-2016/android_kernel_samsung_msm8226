...
static DEVICE_ATTR(led_pattern, S_IWUSR|S_IWGRP, NULL, store_max77828_rgb_pattern);
static DEVICE_ATTR(led_blink, S_IWUSR|S_IWGRP, NULL,  store_max77828_rgb_blink);
static DEVICE_ATTR(led_brightness, S_IWUSR|S_IWGRP, NULL, store_max77828_rgb_brightness);
static DEVICE_ATTR(led_lowpower, S_IWUSR|S_IWGRP, NULL,  store_max77828_rgb_lowpower);
#endif
