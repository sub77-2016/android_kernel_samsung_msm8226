...
#endif /* !CONFIG_MUIC_MAX77828_SUPPORT_CAR_DOCK */
static DEVICE_ATTR(chg_type, S_IRUGO, max77828_muic_show_charger_type, NULL);
static DEVICE_ATTR(uart_sel, S_IRUGO|S_IWUSR|S_IWGRP, max77828_muic_show_uart_sel,
		max77828_muic_set_uart_sel);
static DEVICE_ATTR(afc_disable, S_IRUGO|S_IWUSR|S_IWGRP, max77828_muic_show_afc_disable,
		max77828_muic_set_afc_disable);
#if defined(CONFIG_MUIC_SUPPORT_RUSTPROOF)
static DEVICE_ATTR(uart_en, S_IRUGO|S_IWUSR|S_IWGRP, max77828_muic_show_uart_en,
